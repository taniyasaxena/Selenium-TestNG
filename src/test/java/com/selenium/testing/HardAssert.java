...
public class HardAssert {
	...
	public void LoginAdmin() throws Exception {
		...
		Assert.assertTrue(pageURL.contains("login.jsp"), "Page URL is diffrent");

		WebElement pageLable = w.findElement(By.xpath("/html/body/table/tbody/tr[2]/td[2]/div/h1"));
		String pageLableText = pageLable.getText();

		Assert.assertTrue(pageLableText.contains("Login"), "Page lable doesn't contains login");
...

	{
		...
		Assert.assertTrue(pageURL.contains("main.jsp"), "URL is Mismatch");

		WebElement pageLable = w.findElement(By.xpath("/html/body/table[2]/tbody/tr/td[2]/div/h1"));
		String pageLableText = pageLable.getText();

		Assert.assertTrue(pageLableText.contains("Admin"), "Page lable doesn't contains Admin");
